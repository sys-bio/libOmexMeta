...
It is often useful to have access to the entire biomodels database, though it isn't necessarily obvious how best to
access it. Here, we provide a script that makes use to `bioservices.BioModels` for downloading sbml models
