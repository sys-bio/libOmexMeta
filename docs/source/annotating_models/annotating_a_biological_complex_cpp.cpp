...
int main() {
    ...
    Shc
            ...
            .isVersionOf("OPB:OPB_00340");// Were modelling the chemical concentration
    ...
    shc_sos_grb2
            ...
            .isVersionOf("OPB:OPB_00340")  // Were modelling the chemical concentration
            .isVersionOf("uniprot/P29353") // SHC1
            .isVersionOf("uniprot/Q07889") // SOS1
            .isVersionOf("uniprot/P62993") ;            // GRB2
