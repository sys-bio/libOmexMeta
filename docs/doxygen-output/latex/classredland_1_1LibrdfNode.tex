...
\mbox{\hyperlink{structraptor__term}{librdf\+\_\+node}} $\ast$ {\bfseries get} () const
\item 
...
\begin{DoxyCompactList}\small\item\em get namespace portion of the node. I.\+e. all but last section of the uri \end{DoxyCompactList}\end{DoxyCompactItemize}
...
static void {\bfseries free\+Node} (\mbox{\hyperlink{structraptor__term}{librdf\+\_\+node}} $\ast$node)
\item 
