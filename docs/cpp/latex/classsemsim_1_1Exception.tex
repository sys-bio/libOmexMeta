\hypertarget{classsemsim_1_1Exception}{}\doxysection{semsim\+::Exception Class Reference}
...
\begin{DoxyCompactItemize}
    \item
    \mbox{\hyperlink{classsemsim_1_1Exception_ae32b373f579fc88ca9a9b406327f6549}{Exception}} (const char $\ast$message)
    \item
    \mbox{\hyperlink{classsemsim_1_1Exception_acd15baba130b34cb81da8ce237406e99}{Exception}} (std\+::string message)
    \item
    \mbox{\hyperlink{classsemsim_1_1Exception_a3f2c9347cddce32086f53f360a7839ae}{$\sim$\+Exception}} () noexcept override=default
    \item
    const char $\ast$ \mbox{\hyperlink{classsemsim_1_1Exception_a301e9f6c7020ce7218811f4c0683ee77}{what}} () const noexcept override
\end{DoxyCompactItemize}
\doxysubsection*{Protected Attributes}
\begin{DoxyCompactItemize}
    \item
    std\+::string \mbox{\hyperlink{classsemsim_1_1Exception_a536284719db9cd57b8762e6e5a5a8820}{msg\+\_\+}}
\end{DoxyCompactItemize}
...
{\footnotesize\ttfamily semsim\+::\+Exception\+::\+Exception (\begin{DoxyParamCaption}
...
{\em message}
    & C-\/style string error message. The string contents are copied upon construction. Hence, responsibility for deleting the char$\ast$ lies with the caller. \\
    \hline
\end{DoxyParams}
...
Returns a pointer to the (constant) error description. \begin{DoxyReturn}{Returns}
                                                           A pointer to a const char$\ast$. The underlying memory is in posession of the \mbox{\hyperlink{classsemsim_1_1Exception}{Exception}} object. Callers must not attempt to free the memory.
\end{DoxyReturn}
