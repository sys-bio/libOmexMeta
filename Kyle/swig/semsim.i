...
%
rename (makeComposite)
semsim::AnnotationBase::makeComposite_;
...
l = 0;
for (
std::vector<std::string>::const_iterator j = i->begin();
j!=i->

end();

++j, ++l) {
PyTuple_SetItem(t, l, PyUnicode_FromString(j
->
