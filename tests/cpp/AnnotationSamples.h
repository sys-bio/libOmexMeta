...
public:
    ...
    std::string singular_annotation1 = "<rdf:RDF xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\"\n"
                                       ...
                                       "   xmlns:myOMEX=\"http://MyOmexLibrary.org/myomex.omex\"\n"
                                       "   xmlns:local=\"http://MyOmexLibrary.org/myomex.rdf\"\n"
    ...
    std::string singular_annotation2 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                                       ...
                                       "             xmlns:local=\"http://MyOmexLibrary.org/myomex.rdf\"\n"
                                       "             xml:base=\"file://./MyModel.rdf\">\n"
                                       "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#modelmeta1\">\n"
    ...
    std::string singular_annotation3 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                                       ...
                                       "             xmlns:local=\"http://MyOmexLibrary.org/myomex.rdf\"\n"
                                       "             xml:base=\"file://./MyModel.rdf\">\n"
                                       "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#meta1\">\n"
    ...
    std::string singular_annotation4 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                                       ...
                                       "             xmlns:local=\"http://MyOmexLibrary.org/myomex.rdf\"\n"
                                       "             xml:base=\"file://./MyModel.rdf\">\n"
                                       "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#meta2\">\n"
    ...
    std::string composite_annotation_pe = "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n"
                                          ...
                                          "             xmlns:local=\"http://MyOmexLibrary.org/myomex.rdf\"\n"
                                          "             xml:base=\"file://./MyModel.rdf\">\n"
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#VLV\">\n"
                                          "        <bqbiol:isVersionOf rdf:resource=\"http://identifiers.org/opb/OPB_00154\"/>\n"
                                          "        <bqbiol:isPropertyOf rdf:resource=\"#http://MyOmexLibrary.org/myomex.rdf#entity_0\"/>\n"
                                          "    </rdf:Description>\n"
                                          "    <rdf:Description rdf:about=\"#http://MyOmexLibrary.org/myomex.rdf#entity_0\">\n"
    ...
    std::string composite_annotation_pp = "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n"
                                          ...
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#property_metaid_0\">\n"
                                          "        <bqbiol:isPropertyOf rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#process_metaid_0\"/>\n"
                                          "        <bqbiol:isVersionOf rdf:resource=\"https://identifiers.org/opb/OPB_00592\"/>\n"
                                          "    </rdf:Description>"
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#process_metaid_0\">\n"
                                          "        <semsim:hasSourceParticipant rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#source_0\"/>\n"
                                          "        <semsim:hasSinkParticipant rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#sink_0\"/>\n"
                                          "        <semsim:hasMediatorParticipant rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#mediator_0\"/>\n"
                                          "    </rdf:Description>\n"
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#source_0\">\n"
                                          "        <semsim:hasMultiplier>1.0</semsim:hasMultiplier>\n"
                                          "        <semsim:hasPhysicalEntityReference rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#special_metaid_0\"/>\n"
                                          "    </rdf:Description>\n"
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#sink_0\">\n"
                                          "        <semsim:hasMultiplier>2.0</semsim:hasMultiplier>\n"
                                          "        <semsim:hasPhysicalEntityReference rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#special_metaid_1\"/>\n"
                                          "    </rdf:Description>"
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#mediator_0\">\n"
                                          "        <semsim:hasPhysicalEntityReference rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#special_metaid_2\"/>\n"
                                          "    </rdf:Description>"
                                          "</rdf:RDF>\n";
    ...
    std::string composite_annotation_pf = "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n"
                                          ...
                                          "         xmlns:semsim=\"http://www.bhi.washington.edu/semsim#\"\n"
                                          "             xml:base=\"file://./MyModel.xml\">\n"
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#parameter_metaid_0\">\n"
                                          "        <bqbiol:isPropertyOf rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#force_0\"/>\n"
                                          "        <bqbiol:isVersionOf rdf:resource=\"https://identifiers.org/opb/OPB_01058\"/>\n"
                                          "    </rdf:Description>"
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#force_0\">\n"
                                          "        <semsim:hasSourceParticipant rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#source_0\"/>\n"
                                          "        <semsim:hasSinkParticipant rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#sink_0\"/>\n"
                                          "    </rdf:Description>\n"
                                          "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#source_0\">\n"
    ...
    std::string tabular_data1 = "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n"
                                ...
                                "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#VleftCorArt\">\n"
                                "        <bqbiol:isVersionOf rdf:resource=\"http://identifiers.org/opb/OPB_00154\" />\n"
                                "        <bqbiol:isPropertyOf rdf:resource=\"http://MyOmexLibrary.org/myomex.rdf#entity_0\"/>\n"
                                "    </rdf:Description>\n"
                                "    <rdf:Description rdf:about=\"http://MyOmexLibrary.org/myomex.rdf#entity_0\">\n"
