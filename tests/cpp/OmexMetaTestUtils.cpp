...
bool OmexMetaTestUtils::equals(RDF* actual, RDF* expected, std::string format) {
...
bool OmexMetaTestUtils::equals(RDF* actual, const std::string& expected_string, std::string format) {
...
bool OmexMetaTestUtils::equals(const Triple& actual, const std::string& expected_string, std::string format) {
    RDF actual_rdf;
...
bool OmexMetaTestUtils::equals(const Triples& actual, const std::string& expected_string, std::string format) {
    RDF actual_rdf;
