...
TEST_F(CAPITests, TestPhysicalProcess) {
    ...
    std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                           ...
                           "    <omexmeta:hasPhysicalEntityReference rdf:resource=\"Entity8\"/>\n"
                           "  </rdf:Description>\n"
...
TEST_F(CAPITests, TestPhysicalForce) {
    ...
    std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                           ...
                           "  <rdf:Description rdf:about=\"SourceParticipant0000\">\n"
                           "    <omexmeta:hasMultiplier rdf:datatype=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#http://www.w3.org/2001/XMLSchema#double\">1</omexmeta:hasMultiplier>\n"
                           "    <omexmeta:hasPhysicalEntityReference rdf:resource=\"Entity9\"/>\n"
                           "  </rdf:Description>\n"
                           "</rdf:RDF>\n";
    std::cout << actual << std::endl;
    ASSERT_STREQ(expected.c_str(), actual);
...
//    Editor_toRDF(editor_ptr);
    ...
    std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                           ...
                           "  </rdf:Description>\n"
                           "  <rdf:Description rdf:about=\"PhysicalForce0000\">\n"
                           "    <omexmeta:hasSinkParticipant rdf:resource=\"Sink9\"/>\n"
                           "    <omexmeta:hasSourceParticipant rdf:resource=\"Source1\"/>\n"
                           "  </rdf:Description>\n"
                           "  <rdf:Description rdf:about=\"PhysicalProcess0000\">\n"
                           "    <omexmeta:hasMediatorParticipant rdf:resource=\"Mod4\"/>\n"
                           "    <omexmeta:hasSinkParticipant rdf:resource=\"Sink9\"/>\n"
                           "    <omexmeta:hasSourceParticipant rdf:resource=\"Source1\"/>\n"
                           "  </rdf:Description>\n"
                           "  <rdf:Description rdf:about=\"Sink9\">\n"
                           "    <omexmeta:hasMultiplier rdf:datatype=\"http://www.w3.org/2001/XMLSchema#double\">1</omexmeta:hasMultiplier>\n"
                           "    <omexmeta:hasPhysicalEntityReference rdf:resource=\"Entity8\"/>\n"
                           "  </rdf:Description>\n"
