...
//    semsim::Predicate predicate2(world, bqb_ns, "is", "bqbiol");
//    std::string expected = "http://biomodels.net/biology-qualifiers/is";
//    LibrdfNode node = predicate2.toRdfNode();
...
//    std::string expected = "http://biomodels.net/biology-qualifiers/is";
//    LibrdfNode node = qualifiers.toRdfNode();
//    const char *actual = (const char *) librdf_uri_as_string(node->value.uri);
//    ASSERT_STREQ(expected
//                         .
//
...
//    ASSERT_THROW(semsim::BiomodelsBiologyQualifier
//                         qualifiers(world,
//                         "isnot"),
//                 std::logic_error);
//}
...
//    LibrdfNode node = term.toRdfNode();
//    const char *actual = (const char *) librdf_uri_as_string(node->value.uri);
//    ASSERT_STREQ(expected
//                         .
//
...
//    LibrdfNode n = predicate.toRdfNode();
