...
public:
    ...
    void assertReadAndWrite(const std::string &input_annot, const std::string &input_format,
...
std::string expected = "@base <file://./annotations.rdf> .\n"
                       ...
                       "\n"
                       "";
assertReadAndWrite(samples
.singular_annotation1, "turtle", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation1, "rdfxml-xmp", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation1, "rdfxml-abbrev", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation1, "rdfxml", expected);
}
...
std::string expected = "digraph {\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation1, "dot", expected);
}
...
std::string expected = "{\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation1, "json-triples", expected);
}
...
std::string expected = "\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation1, "json", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation1, "html", expected);
}
...
assertReadAndWrite(samples
.singular_annotation1, "nquads", expected);
}
...
assertReadAndWrite(samples
.singular_annotation2, "ntriples", expected);
}
...
std::string expected = "@base <file://./annotations.rdf> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation2, "turtle", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation2, "rdfxml-xmp", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation2, "rdfxml-abbrev", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation2, "rdfxml", expected);
}
...
std::string expected = "digraph {\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation2, "dot", expected);
}
...
std::string expected = "{\n"
                       ...
                       "  }\n";
assertReadAndWrite(samples
.singular_annotation2, "json-triples", expected);
}
...
std::string expected = "\n"
                       ...
                       "  }\n";
assertReadAndWrite(samples
.singular_annotation2, "json", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "</html>\n";
assertReadAndWrite(samples
.singular_annotation2, "html", expected);
}
...
std::string expected = "<file://./MyModel.xml#modelmeta1> <http://biomodels.net/model-qualifiers/isDescribedBy> <https://identifiers.org/pubmed/12991237> .\n";
assertReadAndWrite(samples
.singular_annotation2, "nquads", expected);
}
...
assertReadAndWrite(samples
.singular_annotation3, "ntriples", expected);
}
...
std::string expected = "@base <file://./annotations.rdf> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation3, "turtle", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation3, "rdfxml-xmp", expected);
}
...
assertReadAndWrite(samples
.singular_annotation3, "rdfxml-abbrev", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation3, "rdfxml", expected);
}
...
std::string expected = "digraph {\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation3, "dot", expected);
}
...
std::string expected = "{\n"
                       ...
                       "  }\n";
assertReadAndWrite(samples
.singular_annotation3, "json-triples", expected);
}
...
std::string expected = "\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation3, "json", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "</html>\n";
assertReadAndWrite(samples
.singular_annotation3, "html", expected);
}
...
std::string expected = "<file://./MyModel.xml#meta1> <http://biomodels.net/biology-qualifiers/is> <https://identifiers.org/chebi/CHEBI:15422> .\n";
assertReadAndWrite(samples
.singular_annotation3, "nquads", expected);
}
...
assertReadAndWrite(samples
.singular_annotation4, "ntriples", expected);
}
...
std::string expected = "@base <file://./annotations.rdf> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation4, "turtle", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation4, "rdfxml-xmp", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation4, "rdfxml-abbrev", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation4, "rdfxml", expected);
}
...
std::string expected = "digraph {\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation4, "dot", expected);
}
...
std::string expected = "{\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation4, "json-triples", expected);
}
...
assertReadAndWrite(samples
.singular_annotation4, "json", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.singular_annotation4, "html", expected);
}
...
std::string expected = "<file://./MyModel.xml#meta2> <http://purl.org/dc/terms/description> \"Cardiomyocyte cytosolic ATP concentration\" .\n";
assertReadAndWrite(samples
.singular_annotation4, "nquads", expected);
}
...
std::string expected = "<file://./VLV> <http://biomodels.net/biology-qualifiers/isVersionOf> <http://identifiers.org/opb/OPB_00154> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "ntriples", expected);
}
...
std::string expected = "@base <file://./annotations.rdf> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "turtle", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "rdfxml-xmp", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "rdfxml-abbrev", expected);
}
...
std::string expected = "digraph {\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "dot", expected);
}
...
std::string expected = "{\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "json-triples", expected);
}
...
std::string expected = "\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "json", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "html", expected);
}
...
std::string expected = "<file://./VLV> <http://biomodels.net/biology-qualifiers/isVersionOf> <http://identifiers.org/opb/OPB_00154> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pe, "nquads", expected);
}
...
std::string expected = "<file://./property_metaid_0> <http://biomodels.net/biology-qualifiers/isPropertyOf> <file://./process_metaid_0> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "ntriples", expected);
}
...
std::string expected = "@base <file://./annotations.rdf> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "turtle", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "rdfxml-xmp", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "rdfxml-abbrev", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "rdfxml", expected);
}
...
std::string expected = "digraph {\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "dot", expected);
}
...
std::string expected = "{\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "json-triples", expected);
}
...
std::string expected = "\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "json", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "html", expected);
}
...
std::string expected = "<file://./property_metaid_0> <http://biomodels.net/biology-qualifiers/isPropertyOf> <file://./process_metaid_0> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pp, "nquads", expected);
}
...
std::string expected = "<file://./parameter_metaid_0> <http://biomodels.net/biology-qualifiers/isPropertyOf> <file://./force_0> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "ntriples", expected);
}
...
assertReadAndWrite(samples
.composite_annotation_pf, "turtle", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "rdfxml-xmp", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "rdfxml-abbrev", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "rdfxml", expected);
}
...
std::string expected = "digraph {\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "dot", expected);
}
...
std::string expected = "{\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "json-triples", expected);
}
...
std::string expected = "\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "json", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "html", expected);
}
...
std::string expected = "<file://./parameter_metaid_0> <http://biomodels.net/biology-qualifiers/isPropertyOf> <file://./force_0> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.composite_annotation_pf, "nquads", expected);
}
...
std::string expected = "<file://./VleftCorArt> <http://biomodels.net/biology-qualifiers/isVersionOf> <http://identifiers.org/opb/OPB_00154> .\n"
                       ...
                       "";
assertReadAndWrite(samples
.tabular_data1, "ntriples", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.tabular_data1, "rdfxml-xmp", expected);
}
...
std::string expected = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                       ...
                       "";
assertReadAndWrite(samples
.tabular_data1, "rdfxml-abbrev", expected);
}
...
std::string expected = "{\n"
                       ...
                       "";
assertReadAndWrite(samples
.tabular_data1, "json-triples", expected);
}
...
semsim::SemsimUtils::download(samples
