...
//    Editor_toRDF(editor_ptr);
    ...
    std::string expected = "<?xml version=\"1.1\" encoding=\"utf-8\"?>\n"
                           ...
                           "    <bqbiol:isPropertyOf rdf:resource=\"EntityProperty0000\"/>\n"
                           "    <bqbiol:isVersionOf rdf:resource=\"https://identifiers.org/opb/opb_465\"/>\n"
                           "  </rdf:Description>\n"
                           "</rdf:RDF>\n";
