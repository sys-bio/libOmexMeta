...
if (sbml_FOUND)
  get_target_property(libSBML_LIBRARY_VAR sbml LOCATION)
  set(libSBML_LIBRARY ${libSBML_LIBRARY_VAR} CACHE PATH "Path to libsbml")
  ...
  set(libSBML_LIBRARY ${libSBML_sbml_LIBRARY} CACHE PATH "Path to libsbml")
endif()
