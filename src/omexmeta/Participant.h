...
namespace omexmeta {
    ...
    public:
         ...
         */
        SourceParticipant(librdf_model *model, int multiplier, std::string physicalEntityReference, std::string local_uri);
    };
    ...
    public:
         ...
         */
        SinkParticipant(librdf_model *model, int multiplier, std::string physicalEntityReference, std::string local_uri);
