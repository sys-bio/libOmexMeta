...
int
raptor_object_options_get_option(raptor_object_options *options, raptor_option option, char **string_p, int *integer_p);

int
raptor_object_options_set_option(raptor_object_options *options, raptor_option option, const char *string, int integer);
...
struct raptor_parser_factory_s {
     ...
     */
    int (*recognise_syntax)(raptor_parser_factory *factory, const unsigned char *buffer, size_t len,
                            const unsigned char *identifier, const unsigned char *suffix, const char *mime_type);
...
raptor_serializer_register_factory(raptor_world *world, int (*factory)(raptor_serializer_factory *));
...
/* raptor_ntriples.c */
size_t raptor_ntriples_parse_term(raptor_world *world, raptor_locator *locator, unsigned char *string, size_t *len_p,
...
RAPTOR_INTERNAL_API void
raptor_parser_log_error_varargs(raptor_parser *parser, raptor_log_level level, const char *message,
                                va_list arguments) RAPTOR_PRINTF_FORMAT(3, 0);
...
void raptor_log_error_varargs(raptor_world *world, raptor_log_level level, raptor_locator *locator, const char *message,
                              va_list arguments) RAPTOR_PRINTF_FORMAT(4, 0);

RAPTOR_INTERNAL_API void
raptor_log_error_formatted(raptor_world *world, raptor_log_level level, raptor_locator *locator, const char *message,
                           ...) RAPTOR_PRINTF_FORMAT(4, 5);
...
int raptor_www_curl_set_ssl_cert_options(raptor_www *www, const char *cert_filename, const char *cert_type,
...
raptor_id_set_add(raptor_id_set *set, raptor_uri *base_uri, const unsigned char *item, size_t item_len);
...
void raptor_sax2_unparsed_entity_decl(void *user_data, const unsigned char *entityName, const unsigned char *base,
                                      const unsigned char *systemId, const unsigned char *publicId,
                                      const unsigned char *notationName);

int raptor_sax2_external_entity_ref(void *user_data, const unsigned char *context, const unsigned char *base,
                                    const unsigned char *systemId, const unsigned char *publicId);
...
/* turtle_common.c */
RAPTOR_INTERNAL_API int
raptor_stringbuffer_append_turtle_string(raptor_stringbuffer *stringbuffer, const unsigned char *text, size_t len,
                                         int delim, raptor_simple_message_handler error_handler, void *error_data,
                                         int is_uri);
...
int raptor_abbrev_subject_add_property(raptor_abbrev_subject *subject, raptor_abbrev_node *predicate,
...
raptor_abbrev_subject *
raptor_abbrev_subject_lookup(raptor_avltree *nodes, raptor_avltree *subjects, raptor_avltree *blanks,
                             raptor_term *term);
...
raptor_qname *
raptor_new_qname_from_resource(raptor_sequence *namespaces, raptor_namespace_stack *nstack, int *namespace_count,
...
RAPTOR_INTERNAL_API raptor_turtle_writer *
raptor_new_turtle_writer(raptor_world *world, raptor_uri *base_uri, int write_base_uri, raptor_namespace_stack *nstack,
...
RAPTOR_INTERNAL_API void
raptor_turtle_writer_raw_counted(raptor_turtle_writer *turtle_writer, const unsigned char *s, unsigned int len);

RAPTOR_INTERNAL_API void
raptor_turtle_writer_namespace_prefix(raptor_turtle_writer *turtle_writer, raptor_namespace *ns);
...
RAPTOR_INTERNAL_API int
raptor_turtle_writer_literal(raptor_turtle_writer *turtle_writer, raptor_namespace_stack *nstack,
                             const unsigned char *s, const unsigned char *lang, raptor_uri *datatype);

RAPTOR_INTERNAL_API void raptor_turtle_writer_qname(raptor_turtle_writer *turtle_writer, raptor_qname *qname);

RAPTOR_INTERNAL_API int
raptor_turtle_writer_quoted_counted_string(raptor_turtle_writer *turtle_writer, const unsigned char *s, size_t length);

void raptor_turtle_writer_comment(raptor_turtle_writer *turtle_writer, const unsigned char *s);

RAPTOR_INTERNAL_API int
raptor_turtle_writer_set_option(raptor_turtle_writer *turtle_writer, raptor_option option, int value);

int raptor_turtle_writer_set_option_string(raptor_turtle_writer *turtle_writer, raptor_option option,
                                           const unsigned char *value);
...
int raptor_json_writer_key_value(raptor_json_writer *json_writer, const char *key, size_t key_len, const char *value,
                                 size_t value_len);
...
int
raptor_json_writer_literal_object(raptor_json_writer *json_writer, unsigned char *s, size_t s_len, unsigned char *lang,
                                  raptor_uri *datatype);
...
int raptor_rdfxmla_serialize_set_xml_writer(raptor_serializer *serializer, raptor_xml_writer *xml_writer,
                                            raptor_namespace_stack *nstack);
