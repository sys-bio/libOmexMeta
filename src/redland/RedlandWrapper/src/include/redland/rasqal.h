 ...
 */
typedef unsigned char *(*rasqal_generate_bnodeid_handler)(rasqal_world *world, void *user_data,
...
struct rasqal_triples_match_s {
    ...
    rasqal_triple_parts (*bind_match)(struct rasqal_triples_match_s *rtm, void *user_data, rasqal_variable *bindings[4],
...
struct rasqal_triples_source_s {
    ...
    /* API v1 */
    int (*init_triples_match)(rasqal_triples_match *rtm, struct rasqal_triples_source_s *rts, void *user_data,
...
typedef struct {
    ...
    /* API v1 */
    int
    (*new_triples_source)(rasqal_query *query, void *factory_user_data, void *user_data, rasqal_triples_source *rts);

    /* API v2 onwards */
    int
    (*init_triples_source)(rasqal_query *query, void *factory_user_data, void *user_data, rasqal_triples_source *rts,
                           rasqal_triples_error_handler handler);

    /* API v3 onwards */
    int
    (*init_triples_source2)(rasqal_world *world, raptor_sequence *data_graphs, void *factory_user_data, void *user_data,
                            rasqal_triples_source *rts, rasqal_triples_error_handler2 handler, unsigned int flags);
} rasqal_triples_source_factory;
