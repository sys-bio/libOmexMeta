...
rasqal_rowsource_rdf_process(rasqal_rowsource_rdf_context *con) {
    ...
    rasqal_free_literal(predicate_uri_literal);
    predicate_uri_literal = NULL;
    rasqal_free_literal(object_uri_literal);
    object_uri_literal = NULL;
    ...
    rasqal_free_dataset_term_iterator(solution_iter);
    solution_iter = NULL;
    ...
    while (1) {
        ...
        rasqal_free_dataset_term_iterator(binding_iter);
        binding_iter = NULL;
    ...
    rasqal_free_literal(value_predicate);
    value_predicate = NULL;
    rasqal_free_literal(variable_predicate);
    variable_predicate = NULL;
    rasqal_free_literal(predicate_uri_literal);
    predicate_uri_literal = NULL;
    rasqal_free_literal(binding_uri_literal);
    binding_uri_literal = NULL;
...
static void
rasqal_query_results_format_rdf_copy_syntax_description_from_parser(rasqal_query_results_format_factory *factory,
                                                                    const char *name) {
