    ...
    if (svc->data_graphs) {
        ...
        for (i = 0, bg_graph_count = 0;
            ...
            if (dg->flags & RASQAL_DATA_GRAPH_BACKGROUND) {
                ...
                raptor_stringbuffer_append_counted_string(uri_sb,
                                                          RASQAL_GOOD_CAST(const unsigned char*, "&default-graph-uri="),
                                                          19, 1);
                graph_uri = dg->uri;
            } else {
                raptor_stringbuffer_append_counted_string(uri_sb,
                                                          RASQAL_GOOD_CAST(const unsigned char*, "&named-graph-uri="),
                                                          17, 1);
            ...
            raptor_stringbuffer_append_uri_escaped_counted_string(uri_sb,
                                                                  RASQAL_GOOD_CAST(const char*, graph_str), graph_len,
                                                                  1);
        }
    }
