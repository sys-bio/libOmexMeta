...
/*
 * There is a leak in librdf/raptor somewhere to do with namespaces
 * This is a rest to help me find it.
 */

TEST(DotNamespaceLeak, TEST){
    /*
     * Settings
     */
