...
//
//    redland::LibrdfStorage storage1 = LibrdfStorage("memory", "semsim_store1");
//    redland::LibrdfStorage storage2 = storage1;
...
//
//    redland::LibrdfStorage storage1 = LibrdfStorage("memory", "semsim_store1");
//    redland::LibrdfStorage storage2 = LibrdfStorage("memory", "semsim_store2");
//    storage2 = storage1;
//    ASSERT_EQ(storage1, storage2);
//}
