...
static int rasqal_redland_init_triples_match(rasqal_triples_match *rtm, rasqal_triples_source *rts, void *user_data,
...
redland_node_to_rasqal_literal(librdf_world *world, librdf_node *node) {
    ...
    if (librdf_node_is_resource(node)) {
        ...
        l = rasqal_new_string_literal(world->rasqal_world_ptr, (const unsigned char *) new_string, new_language,
                                      new_datatype, NULL);
    } else {
