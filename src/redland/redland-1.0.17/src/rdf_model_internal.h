...
struct librdf_model_factory_s {
    ...
    librdf_stream *
    (*find_statements_with_options)(librdf_model *model, librdf_statement *statement, librdf_node *context_node,
                                    librdf_hash *options);
     ...
     */
    librdf_stream *
    (*find_statements_in_context)(librdf_model *model, librdf_statement *statement, librdf_node *context_node);
...
/* class methods */
void librdf_model_register_factory(librdf_world *world, const char *name, const char *label,
