...
struct librdf_storage_virtuoso_connection_s {
    ...
    librdf_node *
    (*v_rdf2node)(librdf_storage *storage, librdf_storage_virtuoso_connection *handle, int col, char *data);

    char *(*v_GetDataCHAR)(librdf_world *world, librdf_storage_virtuoso_connection *handle, int col, int *is_null);

    int
    (*v_GetDataINT)(librdf_world *world, librdf_storage_virtuoso_connection *handle, int col, int *is_null, int *val);
};
