...
librdf_hash_memory_find_node(librdf_hash_memory_context *hash, void *key, size_t key_len, int *bucket,
...
static int
librdf_hash_memory_cursor_get(void *context, librdf_hash_datum *key, librdf_hash_datum *value, unsigned int flags);
...
static int librdf_hash_memory_open(void *context, const char *identifier, int mode, int is_writable, int is_new,
                                   librdf_hash *options);
