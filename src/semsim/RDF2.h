...
#ifndef LIBSEMSIM_RDF2_H
#define LIBSEMSIM_RDF2_H
...
namespace semsim {
    ...
    public:
        ...
        explicit RDF2(const std::string &base_uri = "./Annotations.rdf", const std::string &storage_type = "memory",
