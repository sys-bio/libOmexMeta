...
//            : LibrdfSerializer(format_.c_str(), mime_type_, type_uri_),
//
//            model_(model), base_uri_(std::move(base_uri)), format_(std::move(format)),
//              mime_type_(mime_type), type_uri_(type_uri) {
//        if (std::find(valid_writer_names.begin(), valid_writer_names.end(), this->format_) ==
//            valid_writer_names.end()) {
...
//
//    void Writer::registerNamespace(const std::string &ns, const std::string &prefix) {
//        serializer.setNamespace(ns, prefix);
//    }
//
//    void Writer::registerNamespace(const std::unordered_map<std::string, std::string> &ns_map) {
//        for (auto &i : ns_map) {
//            registerNamespace(i.first, i.second);
//        }
//    }
//
//    void Writer::setOption(const std::string &option, const std::string &value) {
...
//    }
//
//    void Writer::toFile(std::string format) {
//
//    }
//
//    void Writer::setFormat(const std::string &format) {
//        Writer::format_ = format;
//    }
//
//    void Writer::validateBaseUri() {
