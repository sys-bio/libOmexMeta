...
namespace semsim {
    ...
    public:
         ...
         */
        static inline void stripAnnotationsFromElement(LIBSBML_CPP_NAMESPACE_QUALIFIER SBase *x) {
         ...
         */
        static inline void stripAnnotations(LIBSBML_CPP_NAMESPACE_QUALIFIER SBMLDocument *d) {
